...
FACTION_MODEL_PATH = os.path.join(ROOT_DIR ,"weights/mask_rcnn_faction_v1.h5")
...
# Classes in model
class_names = ['BG', 'A', 'B', 'C', 'I', 'IM', 'ME', 'PLA', 'PLAM', 'R', 'T', 'USA', 'USM']
team = 'I'
...
while True:
    ...
    cv2.moveWindow("img", 0, 720)   # Move down the window to the second screen
